...
namespace InfectedQualities.Content.Tiles.Plants
{
    public class HallowedTree : ModTree
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                ModContent.GetInstance<ServerConfig>().EnableInfectedJungleBiomes ? ModContent.TileType<HallowedJungleGrass>() : -1,
                ModContent.GetInstance<ServerConfig>().EnableInfectedSnowBiomes ? ModContent.TileType<HallowedSnow>() : -1
            };
        }
