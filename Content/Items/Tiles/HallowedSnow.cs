...
namespace InfectedQualities.Content.Items.Tiles
{
    public class HallowedSnow : ModItem
    {
        ...
        public override string Texture => "InfectedQualities/Client/Assets/Items/Tiles/HallowedSnow";

        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(ModContent.TileType<Content.Tiles.HallowedSnow>());
